...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\DocumentType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\DocumentType']) ? $this->services['AppBundle\Form\DocumentType'] : $this->services['AppBundle\Form\DocumentType'] = new \AppBundle\Form\DocumentType()) && false ?: '_'};
}, 'AppBundle\\Form\\EmployeeSkillEompetencyDocumentType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\EmployeeSkillEompetencyDocumentType']) ? $this->services['AppBundle\Form\EmployeeSkillEompetencyDocumentType'] : $this->services['AppBundle\Form\EmployeeSkillEompetencyDocumentType'] = new \AppBundle\Form\EmployeeSkillEompetencyDocumentType()) && false ?: '_'};
}, 'AppBundle\\Form\\TestType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\TestType']) ? $this->services['AppBundle\Form\TestType'] : $this->services['AppBundle\Form\TestType'] = new \AppBundle\Form\TestType()) && false ?: '_'};
