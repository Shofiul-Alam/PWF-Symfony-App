 ...
 */
class EmployeeTimesheetDocument extends \BackendBundle\Entity\EmployeeTimesheetDocument implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'alt', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'width', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'height', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'path', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'fileName', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'mime', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'storageType', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'size', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'uploadedDate', '' . "\0" . 'BackendBundle\\Entity\\EmployeeTimesheetDocument' . "\0" . 'timeSheet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmployeeTimesheetDocument $proxy) {
