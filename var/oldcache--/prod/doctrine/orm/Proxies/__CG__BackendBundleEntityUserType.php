 ...
 */
class UserType extends \BackendBundle\Entity\UserType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\UserType' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\UserType' . "\0" . 'type'];
        }
