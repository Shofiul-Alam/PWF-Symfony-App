 ...
 */
class EmployeeOrderCategory extends \BackendBundle\Entity\EmployeeOrderCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\EmployeeOrderCategory' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\EmployeeOrderCategory' . "\0" . 'categoryName', '' . "\0" . 'BackendBundle\\Entity\\EmployeeOrderCategory' . "\0" . 'pricePerHour', '' . "\0" . 'BackendBundle\\Entity\\EmployeeOrderCategory' . "\0" . 'employee'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmployeeOrderCategory $proxy) {
