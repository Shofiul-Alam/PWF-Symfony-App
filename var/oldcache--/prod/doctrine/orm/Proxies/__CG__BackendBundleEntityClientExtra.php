 ...
 */
class ClientExtra extends \BackendBundle\Entity\ClientExtra implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\ClientExtra' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\ClientExtra' . "\0" . 'title', '' . "\0" . 'BackendBundle\\Entity\\ClientExtra' . "\0" . 'description', '' . "\0" . 'BackendBundle\\Entity\\ClientExtra' . "\0" . 'client'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClientExtra $proxy) {
