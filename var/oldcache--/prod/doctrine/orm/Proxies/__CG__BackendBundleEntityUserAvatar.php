 ...
 */
class UserAvatar extends \BackendBundle\Entity\UserAvatar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'alt', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'width', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'height', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'path', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'fileName', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'mime', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'storageType', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'size', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'uploadedDate', '' . "\0" . 'BackendBundle\\Entity\\UserAvatar' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserAvatar $proxy) {
