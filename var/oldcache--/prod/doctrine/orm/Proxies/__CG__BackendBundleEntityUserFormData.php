 ...
 */
class UserFormData extends \BackendBundle\Entity\UserFormData implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\UserFormData' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\UserFormData' . "\0" . 'value', '' . "\0" . 'BackendBundle\\Entity\\UserFormData' . "\0" . 'valueArrId', '' . "\0" . 'BackendBundle\\Entity\\UserFormData' . "\0" . 'fieldId', '' . "\0" . 'BackendBundle\\Entity\\UserFormData' . "\0" . 'form', '' . "\0" . 'BackendBundle\\Entity\\UserFormData' . "\0" . 'users'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserFormData $proxy) {
