 ...
 */
class Induction extends \BackendBundle\Entity\Induction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Induction' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Induction' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\Induction' . "\0" . 'form', '' . "\0" . 'BackendBundle\\Entity\\Induction' . "\0" . 'job'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Induction $proxy) {
