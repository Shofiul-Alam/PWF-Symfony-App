 ...
 */
class EmployeeInduction extends \BackendBundle\Entity\EmployeeInduction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\EmployeeInduction' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\EmployeeInduction' . "\0" . 'description', '' . "\0" . 'BackendBundle\\Entity\\EmployeeInduction' . "\0" . 'uploadedDate', '' . "\0" . 'BackendBundle\\Entity\\EmployeeInduction' . "\0" . 'modifiedDate', '' . "\0" . 'BackendBundle\\Entity\\EmployeeInduction' . "\0" . 'employee', '' . "\0" . 'BackendBundle\\Entity\\EmployeeInduction' . "\0" . 'employeeSkillDocument', '' . "\0" . 'BackendBundle\\Entity\\EmployeeInduction' . "\0" . 'induction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmployeeInduction $proxy) {
    ...
    public function setEmployeeSkillDocument(\BackendBundle\Entity\EmployeeSkillDocument $employeeSkillDocument = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEmployeeSkillDocument', [$employeeSkillDocument]);

        return parent::setEmployeeSkillDocument($employeeSkillDocument);
    }
    ...
    public function getEmployeeSkillDocument()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEmployeeSkillDocument', []);

        return parent::getEmployeeSkillDocument();
    }
    ...
    public function setInduction(\BackendBundle\Entity\Induction $induction = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInduction', [$induction]);

        return parent::setInduction($induction);
    }
