 ...
 */
class InductionPermission extends \BackendBundle\Entity\InductionPermission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\InductionPermission' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\InductionPermission' . "\0" . 'employee', '' . "\0" . 'BackendBundle\\Entity\\InductionPermission' . "\0" . 'induction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InductionPermission $proxy) {
