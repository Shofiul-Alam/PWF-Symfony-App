 ...
 */
class AllocatedInduction extends \BackendBundle\Entity\AllocatedInduction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\AllocatedInduction' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\AllocatedInduction' . "\0" . 'induction', '' . "\0" . 'BackendBundle\\Entity\\AllocatedInduction' . "\0" . 'project'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AllocatedInduction $proxy) {
