 ...
 */
class EmployeeVisa extends \BackendBundle\Entity\EmployeeVisa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\EmployeeVisa' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\EmployeeVisa' . "\0" . 'issueDate', '' . "\0" . 'BackendBundle\\Entity\\EmployeeVisa' . "\0" . 'expiryDate', '' . "\0" . 'BackendBundle\\Entity\\EmployeeVisa' . "\0" . 'employeeOtherDocument'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmployeeVisa $proxy) {
