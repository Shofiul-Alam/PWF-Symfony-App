 ...
 */
class AllocatedContact extends \BackendBundle\Entity\AllocatedContact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\AllocatedContact' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\AllocatedContact' . "\0" . 'client', '' . "\0" . 'BackendBundle\\Entity\\AllocatedContact' . "\0" . 'contact', '' . "\0" . 'BackendBundle\\Entity\\AllocatedContact' . "\0" . 'project', '' . "\0" . 'BackendBundle\\Entity\\AllocatedContact' . "\0" . 'order'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AllocatedContact $proxy) {
    ...
    public function getOrigId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrigId', []);

        return parent::getOrigId();
    }
