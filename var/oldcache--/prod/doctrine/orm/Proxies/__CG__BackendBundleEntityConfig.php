 ...
 */
class Config extends \BackendBundle\Entity\Config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Config' . "\0" . 'category', '' . "\0" . 'BackendBundle\\Entity\\Config' . "\0" . 'property', '' . "\0" . 'BackendBundle\\Entity\\Config' . "\0" . 'value', '' . "\0" . 'BackendBundle\\Entity\\Config' . "\0" . 'id'];
        }
