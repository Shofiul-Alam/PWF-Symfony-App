 ...
 */
class AllocatedSkillCompetency extends \BackendBundle\Entity\AllocatedSkillCompetency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\AllocatedSkillCompetency' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\AllocatedSkillCompetency' . "\0" . 'project', '' . "\0" . 'BackendBundle\\Entity\\AllocatedSkillCompetency' . "\0" . 'skillCompetencyList'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AllocatedSkillCompetency $proxy) {
