 ...
 */
class EmployeeIdCard extends \BackendBundle\Entity\EmployeeIdCard implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\EmployeeIdCard' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\EmployeeIdCard' . "\0" . 'issueDate', '' . "\0" . 'BackendBundle\\Entity\\EmployeeIdCard' . "\0" . 'expiryDate', '' . "\0" . 'BackendBundle\\Entity\\EmployeeIdCard' . "\0" . 'employeeOtherDocument'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmployeeIdCard $proxy) {
    ...
    public function setEmployeeOtherDocument(\BackendBundle\Entity\EmployeeOtherDocument $employeeOtherDocument = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEmployeeOtherDocument', [$employeeOtherDocument]);

        return parent::setEmployeeOtherDocument($employeeOtherDocument);
    }
    ...
    public function getEmployeeOtherDocument()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEmployeeOtherDocument', []);

        return parent::getEmployeeOtherDocument();
    }
