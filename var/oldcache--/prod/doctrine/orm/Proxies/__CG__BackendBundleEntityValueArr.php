 ...
 */
class ValueArr extends \BackendBundle\Entity\ValueArr implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\ValueArr' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\ValueArr' . "\0" . 'label', '' . "\0" . 'BackendBundle\\Entity\\ValueArr' . "\0" . 'value', '' . "\0" . 'BackendBundle\\Entity\\ValueArr' . "\0" . 'selected', '' . "\0" . 'BackendBundle\\Entity\\ValueArr' . "\0" . 'correct', '' . "\0" . 'BackendBundle\\Entity\\ValueArr' . "\0" . 'field'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ValueArr $proxy) {
    ...
    public function isCorrect()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isCorrect', []);
