 ...
 */
class SkillCompetencyList extends \BackendBundle\Entity\SkillCompetencyList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\SkillCompetencyList' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\SkillCompetencyList' . "\0" . 'name'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SkillCompetencyList $proxy) {
