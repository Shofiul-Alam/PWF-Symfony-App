 ...
 */
class UserFormSubmission extends \BackendBundle\Entity\UserFormSubmission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\UserFormSubmission' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\UserFormSubmission' . "\0" . 'form', '' . "\0" . 'BackendBundle\\Entity\\UserFormSubmission' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserFormSubmission $proxy) {
