...
class ManageClientController extends AAdmin {
    ...
    public function newAction(Request $request)
    {
        ...
        $avatar =  json_decode(urldecode($request->get('upload', null)));
    ...
    public function registerClient(Request $request)
    {
        ...
        $helpers = $this->get(Helpers::class);
        $json = urldecode($request->get('json', null));
//        $contacts = urldecode($request->get('contacts', null));
...
//                    }
    ...
    public function addClientDocumentAction (Request $request) {
